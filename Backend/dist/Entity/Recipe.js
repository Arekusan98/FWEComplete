...
let Recipe = /** @class */ (() => {
    ...
    __decorate([
        typeorm_1.OneToMany(() => IngredientToRecipe_1.IngredientToRecipe, ingredientToRecipe => ingredientToRecipe.recipe, { cascade: true }),
        __metadata("design:type", Array)
    ], Recipe.prototype, "ingredientToRecipe", void 0);
    Recipe = __decorate([
        typeorm_1.Entity()
    ], Recipe);
    return Recipe;
